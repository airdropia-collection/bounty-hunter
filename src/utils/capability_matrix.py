...
CAPABILITIES: dict[str, LanguageCapability] = {
    ...
    "go": LanguageCapability(
        ...
        notes="Can read, write, and test Go. go test + go vet available on GitHub Actions runners.",
    ),
    "rust": LanguageCapability(
        ...
        notes="Can read and write Rust. cargo test + clippy. Slightly below 80% threshold for complex async/lifetime code.",
    ),
